...
class IndexRegistrantDatabase extends Component
{
    use WithPagination;
    ...
    public function deleteStudent($id)
    {
        try {
            ...
            $this->redirect(route('admin.master_data.registrant_database.index'), navigate: true);
        } catch (\Throwable $th) {
    ...
    {
        if ($this->isMobile) {
            return view('livewire.mobile.admin.master-data.registrant-database.index-registrant-database')->layout('components.layouts.mobile.mobile-app', [
                'isShowBottomNavbar' => true,
                'isShowTitle' => true,
            ]);
        }
        return view('livewire.web.admin.master-data.registrant-database.index-registrant-database')->layout('components.layouts.web.web-app');
    }
}
