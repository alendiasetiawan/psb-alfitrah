...
$classes = Flux::classes()
    ...
    ->add('disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none hover:cursor-pointer')
    ->add(match ($size) { // Size...
    ...
    ->add($variant === 'primary' ? match ($color) {
        ...
        'primary' => '[--color-accent:var(--color-primary-600)] [--color-accent-content:var(--color-primary-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-primary-600)] dark:[--color-accent-content:var(--color-primary-400)] dark:[--color-accent-foreground:var(--color-white)]',
