...
$classes = Flux::classes()
    ...
    ->add(match ($variant) {
        default => 'bg-white/10 shadow-[inset_0_2px_2px_rgba(255,255,255,0.7)] backdrop-blur-lg dark:bg-zinc-800 border border-transparent dark:border-zinc-700',
        'flyout' => 'bg-white/10 shadow-[inset_0_2px_2px_rgba(255,255,255,0.7)] backdrop-blur-lg dark:bg-zinc-800 border-transparent dark:border-zinc-700',
        'bare' => 'bg-transparent',
    });
