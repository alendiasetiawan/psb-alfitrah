<div class="flex flex-col gap-6">
    @if (session('resend-otp-success'))
        ...
        <!--#OTP Verification-->
    @else
        <x-auth-header :title="__('PSB Online Al Fitrah Islamic School')" :description="__('Silahkan masuk untuk mengikuti rangkaian proses Penerimaan Santri Baru secara Online')" />
