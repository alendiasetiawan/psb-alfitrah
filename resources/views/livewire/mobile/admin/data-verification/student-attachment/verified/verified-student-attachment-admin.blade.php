<div class="mb-18">
    ...
    <x-animations.fade-down showTiming="150">
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            @forelse ($this->verifiedStudentAttachments as $student)
                <div class="col-span-1" wire:key="student-{{ $student->id }}">
                    <x-cards.flat-card wire:click="showStudentAttachment('{{ Crypt::encrypt($student->id) }}')"
                        clickable="true"
                        ...
                        <flux:text variant="soft">
                            Tanggal Verifikasi: <strong
                                class="text-white">{{ \App\Helpers\DateFormatHelper::indoDateTime($student->attachment_verified_at) }}</strong>
                        </flux:text>
        ...
        <div class="grid grid-cols-1 mt-3">
            ...
            @if ($this->verifiedStudentAttachments->hasMorePages())
