            ...
            @else
                <x-cards.soft-glass-card>
                    ...
                    <div class="flex justify-between items-center">
                        <flux:heading size="xl">Form Edit Nilai</flux:heading>
                        <flux:modal.trigger name="add-edit-tester-modal">
                            <flux:button icon="users" variant="primary" wire:click="$dispatch('open-add-edit-tester-modal')" size="sm">
                                Penguji
                            </flux:button>
                        </flux:modal.trigger>
                    </div>
                    ...
                    <form wire:submit="saveScore"
                        ...
                        <div class="flex flex-col justify-center items-center mt-4 gap-2">
                            ...
                            {{-- <flux:modal.close> --}}
                                <flux:button class="w-full" variant="filled" href="{{ route('admin.placement_test.test_result') }}" wire:navigate>
                                    Batal
                                </flux:button>
                            {{-- </flux:modal.close> --}}
                        </div>
