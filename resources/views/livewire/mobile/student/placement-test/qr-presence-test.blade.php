        ...
        >
            <x-cards.soft-glass-card class="md:w-4/6 lg:w-3/6">
                ...
                <div class="flex flex-col items-center space-y-3">
                    ...
                    <template x-if="!isShowQrCode || countdown === 0">
                        <flux:icon.scan-line class="size-50 text-white" />
                    </template>
                    ...
                    <template x-if="!isShowQrCode || countdown === 0">
                        <flux:text variant="bold" class="text-center">
    ...
    <x-animations.fade-down showTiming="50">
        ...
        <div class="grid grid-cols-1 mt-4">
            <x-notifications.basic-alert>
                <x-slot:title>Mohon maaf, halaman ini hanya bisa diakses setelah "Biodata dan Berkas" santri dinyatakan
                    "Valid"</x-slot:title>
                <x-slot:subTitle>
                    Lengkapi biodata dan berkas <flux:link href="{{ route('student.admission_data.biodata') }}"
                        wire:navigate class="text-blue-500">disini</flux:link>
                </x-slot:subTitle>
            </x-notifications.basic-alert>
        </div>
        <!--#Alert When Student Can't Create QR Code-->
