         ...
         <x-animations.fade-down showTiming="50">
            <x-cards.soft-glass-card>
               ...
               <div class="flex flex-col justify-center items-center py-4">
                  ...
                  <flux:text variant="subtle">{{ $detailStudent->reg_number }}</flux:text>
               </div>

               <div class="flex flex-col justify-start items-start mt-3 gap-2">
                  <div>
                     <flux:text variant="strong" size="lg">Username</flux:text>
                     <flux:text variant="ghost">{{ $detailStudent->parent->username }}</flux:text>
                  </div>
                  <div>
                     <flux:text variant="strong" size="lg">Cabang</flux:text>
                     <flux:text variant="ghost">{{ $detailStudent->branch_name }}</flux:text>
                  </div>
                  <div>
                     <flux:text variant="strong" size="lg">Program</flux:text>
                     <flux:text variant="ghost">{{ $detailStudent->program_name }}</flux:text>
                  </div>
                  <div>
                     <flux:text variant="strong" size="lg">Tahun Ajaran</flux:text>
               ...
               <form wire:submit='saveBiodata' x-data="
                  ...
                  <div class="space-y-4 mb-3">
                     ...
                     <div class="grid md:grid-cols-2 gap-3">
                        ...
                        <!--NISN-->
                        <div class="col-span-1">
                           <flux:input label="NISN" icon="id-card" wire:model='form.inputs.nisn' fieldName="nisn"
                     ...
                     <div class="grid grid-cols-1">
                        <!--Address-->
                        <div class="col-span-1">
                           <flux:textarea label="Alamat Siswa" placeholder="Tulis alamat tinggal saat ini dengan lengkap"
                              rows="3" wire:model='form.inputs.address' fieldName="address" isFormObject="true"
                     ...
                     <div class="grid lg:grid-cols-2 gap-3">
                        ...
                        <div class="col-span-1">
                           <flux:input label="Asal Sekolah" placeholder="Tulis nama sekolah" icon="school"
                              wire:model='form.inputs.oldSchoolName' fieldName="oldSchoolName" isValidate="true"
                              isFormObject="true" :disabled="!$isCanEdit ? true : false" />
                        </div>
                        <!--#Old School Name-->
                     ...
                     <div class="grid grid-cols-1">
                        <!--Address-->
                        <div class="col-span-1">
                           <flux:textarea label="Alamat Asal Sekolah" placeholder="Tulis alamat lengkap" rows="3"
                              wire:model='form.inputs.oldSchoolAddress' fieldName="oldSchoolAddress" isValidate="true"
                              isFormObject="true" :disabled="!$isCanEdit ? true : false" />
                        </div>
                        <!--#Address-->
                     </div>
                     ...
                     <div class="grid md:grid-cols-2 gap-3">
                        ...
                        <div class="col-span-1">
                           <flux:field>
                              ...
                              <flux:select wire:model.live='form.inputs.selectedProvinceId' placeholder="Pilih Provinsi"
                        ...
                        <div class="col-span-1">
                           <flux:field>
                              ...
                              <flux:select wire:model.live='form.inputs.selectedRegencyId' placeholder="Pilih Kabupaten"
                        ...
                        <div class="col-span-1">
                           <flux:field>
                              ...
                              <flux:select wire:model.live='form.inputs.selectedDistrictId' placeholder="Pilih Kecamatan"
                     ...
                     <flux:radio.group wire:model="form.inputs.isParent" label="Apakah siswa tinggal bersama orang tua?">
                     ...
                     <template x-if="$wire.form.inputs.isParent == 1">
                        <div class="grid lg:grid-cols-2 gap-3">
                           ...
                           <!--Father Birth Place-->
                           <div class="col-span-1">
                              <flux:input label="Tempat Lahir Ayah" icon="hospital" placeholder="Kota kelahiran"
                                 wire:model='form.inputs.fatherBirthPlace' :disabled="!$isCanEdit ? true : false" required
                                 oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" />
                           </div>
                           <!--#Father Birth Place-->
                     ...
                     <template x-if="$wire.form.inputs.isParent == 1">
                        <div class="grid grid-cols-1 gap-3">
                           <!--Father Address-->
                           <div class="col-span-1">
                              <flux:textarea label="Alamat Ayah" placeholder="Tulis alamat tinggal saat ini dengan lengkap"
                                 rows="3" wire:model='form.inputs.fatherAddress' :disabled="!$isCanEdit ? true : false"
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-3">
                           ...
                           <div class="col-span-1">
                              <x-inputs.searchable-dropdown label="Pekerjaan Ayah" icon="briefcase"
                                 ...
                                 selectedFieldName="fatherSelectedJobId" initFunction="initJobSearch()" isFormObject="true"
                                 required oninvalid="this.setCustomValidity('Pilih pekerjaan')"
                                 oninput="this.setCustomValidity('')" :disabled="!$isCanEdit ? true : false">
                                 @forelse($jobLists as $job)
                                 <x-inputs.dropdown-list selectedName="{{ $job['name'] }}" selectedId="{{ $job['id'] }}"
                                    fieldName="searchFatherJobName" selectedFieldName="fatherSelectedJobId"
                                    isFormObject="true">
                                    {{ $job['name'] }}
                     ...
                     <template x-if="$wire.form.inputs.isParent == 1">
                        <div class="grid lg:grid-cols-2 gap-3">
                           ...
                           <!--Mother Birth Place-->
                           <div class="col-span-1">
                              <flux:input label="Tempat Lahir Ibu" icon="hospital" placeholder="Kota kelahiran"
                                 wire:model='form.inputs.motherBirthPlace' :disabled="!$isCanEdit ? true : false" required
                                 oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" />
                           </div>
                           <!--#Mother Birth Place-->
                     ...
                     <template x-if="$wire.form.inputs.isParent == 1">
                        <div class="grid grid-cols-1 gap-3">
                           <!--Mother Address-->
                           <div class="col-span-1">
                              <flux:textarea label="Alamat Ibu" placeholder="Tulis alamat tinggal saat ini dengan lengkap"
                                 rows="3" wire:model='form.inputs.motherAddress' :disabled="!$isCanEdit ? true : false"
                                 required oninvalid="this.setCustomValidity('Wajib diisi')"
                                 oninput="this.setCustomValidity('')" class="mb-1" />
                              <flux:field variant="inline">
                                 <flux:checkbox x-model="sameAddressAsStudent"
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-3">
                           ...
                           <div class="col-span-1">
                              <x-inputs.searchable-dropdown label="Pekerjaan Ibu" icon="briefcase"
                                 ...
                                 selectedFieldName="motherSelectedJobId" initFunction="initJobSearch()" isFormObject="true"
                                 required oninvalid="this.setCustomValidity('Pilih pekerjaan')"
                                 oninput="this.setCustomValidity('')" :disabled="!$isCanEdit ? true : false">
                                 @forelse($jobLists as $job)
                                 <x-inputs.dropdown-list selectedName="{{ $job['name'] }}" selectedId="{{ $job['id'] }}"
                                    fieldName="searchMotherJobName" selectedFieldName="motherSelectedJobId"
                                    isFormObject="true">
                                    {{ $job['name'] }}
                                 </x-inputs.dropdown-list>
                                 @empty
                     ...
                     <template x-if="$wire.form.inputs.isParent == 0">
                        <div class="grid lg:grid-cols-2 gap-3">
                           ...
                           <div class="col-span-1">
                              <flux:input label="Tempat Lahir Wali" icon="hospital" placeholder="Kota kelahiran"
                                 wire:model='form.inputs.guardianBirthPlace' :disabled="!$isCanEdit ? true : false"
                                 required oninvalid="this.setCustomValidity('Wajib diisi')"
                     ...
                     <template x-if="$wire.form.inputs.isParent == 0">
                        <div class="grid grid-cols-1 gap-3">
                           <!--Guardian Address-->
                           <div class="col-span-1">
                              <flux:textarea label="Alamat Wali" placeholder="Tulis alamat tinggal saat ini dengan lengkap"
                                 rows="3" wire:model='form.inputs.guardianAddress' :disabled="!$isCanEdit ? true : false"
                                 required oninvalid="this.setCustomValidity('Wajib diisi')"
                                 oninput="this.setCustomValidity('')" class="mb-1" />
                              <flux:field variant="inline">
                                 <flux:checkbox x-model="sameAddressAsStudent"
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-3">
                           ...
                           <div class="col-span-1">
                              <x-inputs.searchable-dropdown label="Pekerjaan Wali" icon="briefcase"
                                 ...
                                 isFormObject="true" required oninvalid="this.setCustomValidity('Pilih pekerjaan')"
                                 oninput="this.setCustomValidity('')" :disabled="!$isCanEdit ? true : false">
                                 @forelse($jobLists as $job)
                                 <x-inputs.dropdown-list selectedName="{{ $job['name'] }}" selectedId="{{ $job['id'] }}"
                                    fieldName="searchGuardianJobName" selectedFieldName="guardianSelectedJobId"
                                    isFormObject="true">
                                    {{ $job['name'] }}
                                 </x-inputs.dropdown-list>
                                 @empty
