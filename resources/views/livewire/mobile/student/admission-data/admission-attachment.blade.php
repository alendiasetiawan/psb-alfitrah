<div class="mb-17">
   ...
   <div wire:ignore>
      ...
      <div class="flex flex-col justify-start items-start mt-4">
         <flux:badge color="green" icon="circle-check-big">Berkas Valid</flux:badge>
      </div>
      @endif
   </div>
                  ...
                  <div class="col-span-1">
                     <flux:field>
                        ...
                        <div 
                           ...
                           @if ($detailAttachment->studentAttachment?->photo_status == \App\Enums\VerificationStatusEnum::INVALID)
                              <flux:text><span class="text-red-500">Silahkan upload ulang "Photo Siswa"</span></flux:text>
                           @endif

                           @if ($detailAttachment->studentAttachment?->photo_status == \App\Enums\VerificationStatusEnum::NOT_STARTED || 
                           $detailAttachment->studentAttachment?->photo_status == \App\Enums\VerificationStatusEnum::INVALID || is_null($detailAttachment->studentAttachment))
                              <flux:input 
                                 type="file" 
                                 wire:model.live='studentPhoto'
                           ...
                           @php
                              $isTempUploadStudentPhoto = $studentPhoto instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
                           @endphp
                           @if (!$errors->has('studentPhoto') && $isTempUploadStudentPhoto)
                              ...
                              <img src="{{ $studentPhoto->temporaryUrl() }}" width="250" height="auto" class="mt-2" />
                           @endif
                           <!--Show temporary image preview-->
                        </div>
                        ...
                        \App\Enums\VerificationStatusEnum::VALID)
                           <a href="{{ asset('storage/' . $detailAttachment->studentAttachment->photo) }}" 
                              data-fancybox="valid-attachment"
                              data-caption="Photo Siswa"
                           >
                              <img src="{{ asset('storage/' . $detailAttachment->studentAttachment->photo) }}" width="250" height="auto" />
                           </a>
                        @endif
                        <!--#Gallery Display When File Has Been Uploaded-->
                     </flux:field>
                  ...
                  <div class="col-span-1">
                     <flux:field>
                        ...
                        <div 
                           ...
                           @if ($detailAttachment->studentAttachment?->born_card_status == \App\Enums\VerificationStatusEnum::INVALID)
                              <flux:text><span class="text-red-500">Silahkan upload ulang "Akte Kelahiran"</span></flux:text>
                           @endif

                           @if ($detailAttachment->studentAttachment?->born_card_status == \App\Enums\VerificationStatusEnum::NOT_STARTED || 
                           $detailAttachment->studentAttachment?->born_card_status == \App\Enums\VerificationStatusEnum::INVALID || is_null($detailAttachment->studentAttachment))
                              <flux:input 
                                 type="file" 
                                 wire:model.live='bornCard'
                                 accept="image/png, image/jpg, image/jpeg" 
                              />
                              @error('bornCard')
                           ...
                           @php
                              $isTempUploadBornCard = $bornCard instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
                           @endphp
                        ...
                        \App\Enums\VerificationStatusEnum::VALID)
                           ...
                           >
                              <img src="{{ asset('storage/' . $detailAttachment->studentAttachment->born_card) }}" width="250" height="auto" />
                           </a>
                        @endif
                        <!--#Gallery Display When File Has Been Uploaded-->
                     </flux:field>
                  ...
                  <div class="col-span-1">
                     <flux:field>
                        ...
                        <div 
                           ...
                           @if ($detailAttachment->studentAttachment?->family_card_status == \App\Enums\VerificationStatusEnum::INVALID)
                              <flux:text><span class="text-red-500">Silahkan upload ulang "Kartu Keluarga"</span></flux:text>
                           @endif

                           @if ($detailAttachment->studentAttachment?->family_card_status == \App\Enums\VerificationStatusEnum::NOT_STARTED || 
                           $detailAttachment->studentAttachment?->family_card_status == \App\Enums\VerificationStatusEnum::INVALID || is_null($detailAttachment->studentAttachment))
                              <flux:input 
                                 type="file" 
                                 wire:model.live='familyCard'
                                 accept="image/png, image/jpg, image/jpeg" 
                              />
                              @error('familyCard')
                           ...
                           <!--Show temporary uploaded image preview-->
                           @php
                              $isTempUploadFamilyCard = $familyCard instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
                           @endphp
                           @if (!$errors->has('familyCard') && $isTempUploadFamilyCard)
                              ...
                              <img src="{{ $familyCard->temporaryUrl() }}" width="250" height="auto" class="mt-2" />
                           @endif
                           <!--Show temporary uploaded image preview-->
                        </div>
                        ...
                        \App\Enums\VerificationStatusEnum::VALID)
                           ...
                           >
                              <img src="{{ asset('storage/' . $detailAttachment->studentAttachment->family_card) }}" width="250" height="auto" />
                           </a>
                        @endif
                        <!--#Gallery Display When File Has Been Uploaded-->
                     </flux:field>
                  ...
                  <div class="col-span-1">
                     <flux:field>
                        ...
                        <div 
                           ...
                           @if ($detailAttachment->studentAttachment?->parent_card_status == \App\Enums\VerificationStatusEnum::INVALID)
                              <flux:text><span class="text-red-500">Silahkan upload ulang "KTP Orang Tua"</span></flux:text>
                           @endif

                           @if ($detailAttachment->studentAttachment?->parent_card_status == \App\Enums\VerificationStatusEnum::NOT_STARTED || 
                           $detailAttachment->studentAttachment?->parent_card_status == \App\Enums\VerificationStatusEnum::INVALID || is_null($detailAttachment->studentAttachment))
                              <flux:input 
                                 type="file" 
                                 wire:model.live='parentCard'
                                 accept="image/png, image/jpg, image/jpeg" 
                              />
                              @error('parentCard')
                           ...
                           <!--Show temporary uploaded image preview-->
                           @php
                              $isTempUploadParentCard = $parentCard instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
                           @endphp
                           @if (!$errors->has('parentCard') && $isTempUploadParentCard)
                              ...
                              <img src="{{ $parentCard->temporaryUrl() }}" width="250" height="auto" class="mt-2" />
                           @endif
                           <!--Show temporary uploaded image preview-->
                        </div>
                        ...
                        \App\Enums\VerificationStatusEnum::VALID)
                           ...
                           >
                              <img src="{{ asset('storage/' . $detailAttachment->studentAttachment->parent_card) }}" width="250" height="auto" />
                           </a>
                        @endif
                        <!--#Gallery Display When File Has Been Uploaded-->
                     </flux:field>
