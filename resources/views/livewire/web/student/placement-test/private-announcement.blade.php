<div>
    ...
    <div class="grid-cols-1 mt-4">
        <x-notifications.basic-alert variant="warning" icon="triangle-alert">
            <x-slot:title>Hasil tes bisa dilihat setelah santri mengikuti tes dan hasilnya diumumkan oleh panitia</x-slot:title>
        </x-notifications.basic-alert>
    </div>
    @else
    <div class="grid grid-cols-1 mt-4">
        <div class="col-span-1">
            <x-cards.basic-card>
                ...
                <flux:text variant="strong" class="mt-3">telah mengikuti rangkaian proses tes seleksi masuk dengan hasil
