                    ...
                    <div class="space-y-4 mb-3">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            ...
                            <div class="col-span-1">
                                ...
                                icon="user"
                                wire:model='form.inputs.studentName'
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            ...
                            <div class="col-span-1">
                                ...
                                wire:model='form.inputs.birthPlace'
                            ...
                            <div class="col-span-1">
                                ...
                                label="Tanggal Lahir"
                                type="date" 
                                wire:model='form.inputs.birthDate'
                                fieldName="birthDate"
                                isValidate="true"
                                isFormObject="true"
                                :disabled="!$isCanEdit ? true : false"
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <div class="col-span-1">
                                <flux:textarea 
                                    ...
                                    rows="3"
                                    wire:model='form.inputs.address'
                                    fieldName="address"
                                    isFormObject="true"
                                    isValidate="true"
                                    :disabled="!$isCanEdit ? true : false"
                        ...
                        <div class="grid lg:grid-cols-2 gap-3">
                            ...
                            <div class="col-span-1">
                                <flux:input
                                    ...
                                    icon="school"
                                    wire:model='form.inputs.oldSchoolName'
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <div class="col-span-1">
                                <flux:textarea 
                                    ...
                                    rows="3"
                                    wire:model='form.inputs.oldSchoolAddress'
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            ...
                            <div class="col-span-1">
                                <flux:field>
                                    <flux:label class="gap-2">
                                        Kabupaten/Kota
                                        <flux:icon.loading variant="micro" wire:loading wire:target="form.inputs.selectedProvinceId" />
                                    </flux:label>
                            ...
                            <div class="col-span-1">
                                <flux:field>
                                    <flux:label class="gap-2">
                                        Kecamatan
                                        <flux:icon.loading variant="micro" wire:loading wire:target="form.inputs.selectedRegencyId" />
                                    </flux:label>
                            ...
                            <div class="col-span-1">
                                <flux:field>
                                    <flux:label class="gap-2">
                                        Desa/Kelurahan
                                        <flux:icon.loading variant="micro" wire:loading wire:target="form.inputs.selectedDistrictId" />
                                    </flux:label>
                            ...
                            <div class="grid lg:grid-cols-2 gap-3">
                                ...
                                <div class="col-span-1">
                                    <flux:input
                                        ...
                                        placeholder="Tulis nama lengkap"
                                        icon="user"
                                        wire:model='form.inputs.fatherName'
                                        required
                            ...
                            <div class="grid lg:grid-cols-2 gap-3">
                                ...
                                <div class="col-span-1">
                                    <flux:input
                                        ...
                                        placeholder="Tulis nama lengkap"
                                        icon="user"
                                        wire:model='form.inputs.motherName'
                                        required
                                        oninvalid="this.setCustomValidity('Wajib diisi')"
                                        oninput="this.setCustomValidity('')"
                                        :disabled="!$isCanEdit ? true : false"
                            ...
                            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-3">
                                ...
                                <div class="col-span-1">
                                    <x-inputs.searchable-dropdown
                                        ...
                                        icon="briefcase"
                                        placeholder="Cari nama pekerjaan"
                                        fieldName="searchMotherJobName"
                                        selectedFieldName="motherSelectedJobId"
                                        initFunction="initJobSearch()"
                                        isFormObject="true"
                                        required
                                        oninvalid="this.setCustomValidity('Pilih pekerjaan')"
                            ...
                            <div class="grid lg:grid-cols-2 gap-3">
                                ...
                                <div class="col-span-1">
                                    <flux:input
                                        ...
                                        placeholder="Tulis nama lengkap"
                                        icon="user"
                                        wire:model='form.inputs.guardianName'
                                        required
                                        oninvalid="this.setCustomValidity('Wajib diisi')"
                                        oninput="this.setCustomValidity('')"
                                        :disabled="!$isCanEdit ? true : false"
                            ...
                            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-3">
                                ...
                                <div class="col-span-1">
                                    <x-inputs.searchable-dropdown
                                        ...
                                        icon="briefcase"
                                        placeholder="Cari nama pekerjaan"
                                        fieldName="searchGuardianJobName"
                                        selectedFieldName="guardianSelectedJobId"
                                        initFunction="initJobSearch()"
                                        isFormObject="true"
                                        required
                                        oninvalid="this.setCustomValidity('Pilih pekerjaan')"
