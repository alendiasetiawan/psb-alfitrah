<div>
    <x-navigations.breadcrumb>
        <x-slot:title>{{ __('Biaya Pendaftaran') }}</x-slot:title>
        <x-slot:activePage>{{ __('Pengaturan Biaya Pendaftaran PSB') }}</x-slot:activePage>
    </x-navigations.breadcrumb>
    ...
    <livewire:components.modals.setting.edit-admission-fee-modal modalId="edit-admission-fee-modal" :$activeAdmission/>
    <!--#Add & Edit Admission Quota Modal-->
</div>
