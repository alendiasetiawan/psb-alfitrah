<div>
    <x-navigations.breadcrumb>
        <x-slot:title>{{ __('Kuota Penerimaan') }}</x-slot:title>
        <x-slot:activePage>{{ __('Pengaturan Kuota Penerimaan PSB') }}</x-slot:activePage>
    </x-navigations.breadcrumb>
    ...
    <livewire:components.modals.setting.edit-admission-quota-modal modalId="edit-admission-quota-modal" :$activeAdmission/>
    <!--#Add & Edit Admission Quota Modal-->
</div>
