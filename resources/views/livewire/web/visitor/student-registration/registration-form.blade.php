        ...
        @if ($isAdmissionOpen)
                        ...
                        <form wire:submit='otpVerification' x-data="{
                            ...
                            <div class="flex flex-col justify-center items-center mb-4 text-center space-y-4">
                                ...
                                <flux:text variant="ghost">
                                    Kami telah mengirimkan kode OTP ke nomor whatsapp anda, silahkan masukan kode tersebut pada
                                    kolom di
                                    bawah ini:
                                </flux:text>
            ...
            @else
                ...
                <div class="flex justify-center">
                    <x-cards.soft-glass-card class="md:w-3/6 lg:w-2/6">
                        <div class="flex flex-col justify-center items-center mb-4 text-center">
                            <flux:heading size="xxl">
                                Daftar Akun
                            </flux:heading>
                            <flux:text variant="soft">
                                Lengkapi data di bawah ini untuk membuat akun di <strong class="text-primary-400">Aplikasi PSB Online Al
                                    Fitrah Islamic School</strong>
                            </flux:text>
                        </div>

                        <form wire:submit='saveStudentRegistration' x-data="
                                        formValidation({
                            ...
                            <div class="grid grid-cols-1 mt-4 gap-2">
                                <div class="col-span-1">
                                    <flux:button type="submit" variant="primary"
                                        x-bind:disabled="!isSubmitActive || !$wire.isQuotaAvailable" :loading="false"
                                        class="w-full">
